const CACHE = "sm-owner-shell-v21-consulta";
const SHARE_CACHE = "sm-owner-shared-v1";
const BASE = new URL("./", self.location).pathname;
const SHELL = [BASE, `${BASE}app.css?v=19`, `${BASE}field.css?v=2`, `${BASE}app.js?v=21`, `${BASE}field.js?v=21`, `${BASE}icon.svg`, `${BASE}brahman-opening-v2.png`, `${BASE}manifest.webmanifest`];
