const CACHE = "sm-owner-shell-v9";
const SHARE_CACHE = "sm-owner-shared-v1";
const BASE = new URL("./", self.location).pathname;
const SHELL = [BASE, `${BASE}app.css?v=9`, `${BASE}app.js?v=9`, `${BASE}icon.svg`, `${BASE}manifest.webmanifest`];
